  ...
  const handleSubmit = () => {
    if (sessionStorage.getItem("role")=="Admin"){
      if (password==OldPassword&&NewPassword!=0){
        Axios.post("http://localhost:9091/api/hospital/changePwd", {
      ...
      if (password==OldPassword&&NewPassword!=0){
      Axios.post("http://localhost:9091/api/patient/changePwd", {
        email: sessionStorage.getItem("email"),
        oldPwd:OldPassword,
        newpassword: NewPassword,
      }).then((response) => {
      ...
      if (password==OldPassword&&NewPassword!=0){
        Axios.post("http://localhost:9091/api/admin/changePwd", {
          email: sessionStorage.getItem("email"),
          oldPwd:OldPassword,
          newpassword: NewPassword,
