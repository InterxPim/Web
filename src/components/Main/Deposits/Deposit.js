    ...
    return (
        <Container>
            <Property>
                ...
                <PropertyText>
                    <PropertyStreet>{data.lastname} {data.firstname}</PropertyStreet>
                </PropertyText> 
            </Property>
            <MoveInDate>{data.date}</MoveInDate>
            <Rent>{data.heure.toString().split('T')[0]}</Rent>
            <DepositWrapper>
            ...
            <Status>
                ...
                {(() => {
                    switch (data.result) {
                        case true: return <StatusIndicator color="#F17E7E" />;
                        case false: return <StatusIndicator color="#FFD056" />;
